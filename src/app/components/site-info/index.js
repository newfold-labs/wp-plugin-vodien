...
export const SiteInfoBar = () => {
    ...
    return (
        <div className="wppv-app-site-info nfd-bg-gradient-to-r nfd-from-slate-50 nfd-to-red-50 nfd-w-full nfd-py-6 nfd-px-8 nfd-mb-8 nfd-border nfd-border-slate-200 nfd-rounded-lg nfd-shadow-sm">
