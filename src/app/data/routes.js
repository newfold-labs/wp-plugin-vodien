...
export const routes = [
	{
		name: '/home',
		title: __( 'Home', 'wp-plugin-vodien' ),
		Component: Home,
		Icon: HomeIcon,
		condition: true,
	},
	...
	},
	{
		...
		title: __( 'Performance', 'wp-plugin-vodien' ),
		Component: Settings,
		Icon: BoltIcon,
	...
	{
		name: '/settings',
		title: __( 'Settings', 'wp-plugin-vodien' ),
		Component: Settings,
	...
	{
		name: '/help',
		title: __( 'Help', 'wp-plugin-vodien' ),
		Component: Help,
	...
	{
		name: '/admin',
		title: __( 'Admin', 'wp-plugin-vodien' ),
		Component: Admin,
		condition: true,
	},
];
			...
			<Route
				...
				element={
					<main style={ { padding: '1rem' } }>
						<p>
							{ __( "There's nothing here!", 'wp-plugin-vodien' ) }
						</p>
					</main>
				}
			/>
