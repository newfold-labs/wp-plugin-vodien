...
test.describe('Settings Page', () => {
  ...
  test('Is Accessible', async ({ page }) => {
    ...
    await page.waitForSelector('.wppv-app-body', { timeout: 10000 });
  ...
  test('Has Coming Soon Section', async ({ page }) => {
    const comingSoonSection = page.locator('.wppv-app-settings-coming-soon');
  ...
  test('Autoupdate Toggles function properly', async ({ page }) => {
    const updatesSection = page.locator('.wppv-app-settings-update');
...
test('Comment Settings Work', async ({ page }) => {
    const commentsSection = page.locator('.wppv-app-settings-comments');
